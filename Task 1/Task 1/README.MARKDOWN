...
<p align="center"> 
	<b><a href="#task">Task Overview - JP Morgan Chase & Co</a></b>
...
<ol>
	<li>Clone this repository to start the task in your system</li>
	<li> By adjusting the  main functions , getRatio and getDataPoint</li>
	<li>Pass all unit tests and add more to cover edge cases for Bonus Credits</li>
	<li>Finally upload a git patch file as the submission to this task</li>
...
<p>A patch file is what is required from you to submit. To create a patch file please follow this, <a href="https://insidesherpa.s3.amazonaws.com/vinternships/companyassets/Sj7temL583QAYpHXD/create_patch_file_v3a.pdf">follow this guide</a>. Then submit the patch file in the <a href="https://www.insidesherpa.com/modules/R5iK7HMxJGBgaSbvk/gtAhtcvke9AFCzqME">JPM Module 1 Page</a>.</p>
